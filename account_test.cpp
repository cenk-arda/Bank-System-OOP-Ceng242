...
int main() {
   ...
   // std::cout<< localtime(&time_arr[0])->tm_hour<<":"<<localtime(&time_arr[0])->tm_min<<":"<<localtime(&time_arr[0])->tm_sec<<"-"<<localtime(&time_arr[0])->tm_mday<<"/"<<localtime(&time_arr[0])->tm_mon+1<<"/"<<localtime(&time_arr[0])->tm_year+1900<<"\n";
   // std::cout<< localtime(&time_arr[11])->tm_hour<<":"<<localtime(&time_arr[11])->tm_min<<":"<<localtime(&time_arr[11])->tm_sec<<"-"<<localtime(&time_arr[11])->tm_mday<<"/"<<localtime(&time_arr[11])->tm_mon+1<<"/"<<localtime(&time_arr[11])->tm_year+1900<<"\n";
   // time_t minusone = -1;
//	std::cout<<localtime(&minusone)->tm_hour<<":"<<localtime(&minusone)->tm_min<<":"<<localtime(&minusone)->tm_sec<<"-"<<localtime(&minusone)->tm_mday<<"/"<<localtime(&minusone)->tm_mon+1<<"/"<<localtime(&minusone)->tm_year+1900<<"\n";
